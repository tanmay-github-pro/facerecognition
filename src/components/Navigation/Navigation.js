    ...
    if (isSignedIn) {
      ...
      return (
        <nav style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', padding: '1.5rem 0'}}>
          <h1 className='f1-m f1-l f2 fw5 ph4 mh0 center' style={{ /*marginLeft: '36vw', /*position: 'absolute', top: '20%', left: '50%', transform: 'translate(-50%, -50%)', /*fontSize: '4rem'*/}}>Face Recognition</h1>
